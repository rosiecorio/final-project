            ...
            className="h-[87vh] w-[93vw] bg-[#292728] border border-black  rounded-xl p-6 text-[#f0dddf]">
                <div className="flex flex-col gap-6">
                    <section className="flex flex-col">
                        <label className="text-lg font-semibold text-center" htmlFor="content">
                            Write a Post..
                        </label>
                        <textarea className="h-[40vh] w-full rounded-md bg-[#F0DDDF] text-black p-3 border border-[#292728] focus:outline-none focus:ring-2 focus:ring-[#ed6044] mt-2" 
                        id="content" 
                        name="content"></textarea>
                    </section>
                    {/*Radio Button*/}                
                    <section className="flex flex-col">
                        <label className="text-lg font-semibold text-center underline mb-3" htmlFor="thread_id">
                            Category:
                        </label>       
                ...
                <div className="flex justify-center">
                    <button 
                className="mt-2 w-[15vh] bg-[#ed6044] text-white py-2 rounded-md font-semibold hover:bg-[#e6c2ac] hover:text-[#292728] transition duration-200" 
                type="submit">
                    Submit
                </button> 
                </div>                
